  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-72 h-72 rounded-full bg-primary/6 blur-3xl animate-pulse" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 rounded-full bg-primary/8 blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full bg-primary/3 blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
        ...
        <div className="glass-card rounded-3xl p-8 sm:p-10 space-y-7">
          ...
          {isComingSoon && !submitted && (
            ...
            >
              ...
              <Button type="submit" className="gap-1 rounded-xl px-5 bg-primary text-primary-foreground hover:bg-primary/90">
          ...
          {submitted && (
            <div className="bg-primary/10 text-primary text-sm font-medium px-4 py-3 rounded-xl animate-scale-in">
