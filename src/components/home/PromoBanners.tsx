    ...
    <section className="py-16 lg:py-20">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-5">
          ...
          >
            <div className="relative overflow-hidden rounded-xl bg-primary p-8 lg:p-10 h-full min-h-[280px] flex flex-col justify-between">
              <div>
                <span className="inline-block px-3 py-1 bg-accent text-accent-foreground text-xs font-bold rounded uppercase tracking-wider mb-4">
                  Limited Time
                </span>
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <div className="relative overflow-hidden rounded-xl bg-accent p-8 lg:p-10 h-full min-h-[280px] flex flex-col justify-between">
              <div>
                <span className="inline-block px-3 py-1 bg-card text-foreground text-xs font-bold rounded uppercase tracking-wider mb-4">
                  This Weekend
                </span>
