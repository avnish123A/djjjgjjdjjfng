    ...
    <section className="py-20 lg:py-28 bg-secondary/30">
      <div className="container mx-auto px-4">
        <div className="flex items-end justify-between mb-14">
          <div>
            <span className="text-[11px] font-medium uppercase tracking-[5px] text-accent mb-3 block">Just Launched</span>
            <h2 className="font-display text-3xl sm:text-4xl tracking-tight">Latest Arrivals</h2>
          </div>
          <Link
            to="/products"
